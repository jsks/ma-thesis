...
[@Blattman2017]. Scholars have proposed numerous theories ranging
from motivation-based arguments --- such as, for example, the role of
...
Several studies in this vein have argued in favor of institutions
...
National Material Capabilities v5.0 dataset (1816-2012) [@Singer1972;
...
```{r fig.cap = "\\label{fig:err} Error plots"}
...
```{r fig.width = 7, fig.cap = "\\label{fig:roc} ROC & Precision-Recall Plots"}
