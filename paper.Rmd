...
undermines any general conclusion regarding a pacifying effect.
...
take the mean of GDP per capita growth, CINC, the proportion of
discriminated population, population density, mean elevation, and the
number of politically relevant ethnic groups. I also set the dummy
indicators for independence, major ongoing conflict, and neighbouring
conflict and the random intercepts for year and country to zero. For
peace years I take the intercept for the average number of peace years
rounded to the nearest integer, which turns out to be 19. The levels
of GDP per capita were selected based on the 10\%, 50\%, and 90\%
...
and third, and 4 above the third.
...
interval is only 0.0475 to 0.2 with a max of 0.516. To better compare
the predicted probabilities to the actual data, table
...
table.  `r signif((93 / (259 + 93)) * 100, 3)` percent of onsets and
